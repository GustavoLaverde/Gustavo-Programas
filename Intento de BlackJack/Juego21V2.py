...
imagen4 = PhotoImage(file="restart.png")
frame3=Frame(root)
...
def restart():
    root.destroy()
    os.startfile("BlackJack Barato.exe")
...
reiniciar = Button(root,image=imagen4,bd=3,cursor="hand2",command=restart).place(x=450,y=5,width=45,height=40)
##___________________________________________________________________________________________________##
##___________________________________________________________________________________________________##
root.mainloop() 